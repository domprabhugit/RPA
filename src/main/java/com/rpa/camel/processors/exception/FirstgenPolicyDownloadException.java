...
public class FirstgenPolicyDownloadException implements Processor {

	private static final Logger logger = LoggerFactory.getLogger(FirstgenPolicyDownloadException.class.getName());
	...
	public void process(Exchange exchange)
		...
		logger.info("Inside FirstgenPolicyDownloadException::Process Phase::" + transactionInfo.getProcessPhase());

...
public class AutoInspektDocUploader implements Processor {

	private static final Logger logger = LoggerFactory.getLogger(AutoInspektDocUploader.class.getName());
	...
	public void process(Exchange exchange) throws Exception {
		...
		AutoInspektDocUploader autoInspektDocUploader = new AutoInspektDocUploader();
	...
	public void doProcess(AutoInspektDocUploader autoInspektDocUploader, Exchange exchange,
			TransactionInfo transactionInfo, AutoInspektVirService autoInspektVirService, OmniDocsUploader omniDocUploader,
	...
	public boolean getPolicyNumberListTobeUploadedFromLocalDb(TransactionInfo transactionInfo,
			AutoInspektVirService autoInspektVirService, Exchange exchange, OmniDocsUploader omniDocUploader,
		...
		List<AutoInspektVIR> abiblPolicyNoList = null;
		...
		try{
			...
			for (AutoInspektVIR autoInspektVirObj : abiblPolicyNoList) {	
	...
	private String getNextInwardCode(String paramValue) throws InstantiationException, IllegalAccessException,
		...
		logger.info("autoInspektDocUploader - BEGIN getNextInwardCode() called");
		...
		logger.info("autoInspektDocUploader - END downloadPdf() nextInwardCode ::" + nextInwardCode);

...
@Entity
@Table(name="model_code_creation")
public class ModelCodeCreation  implements  Serializable {
	...
	@Id
	@SequenceGenerator(name = "model_code_creation_seq", sequenceName = "model_code_creation_seq", allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="model_code_creation_seq")
	private long id;
	...
	private String isGridValidated;
	
	private String isModelValidated;
	...
	public String getIsModelCreated() {
		return isModelCreated;
	}

	public void setIsModelCreated(String isModelCreated) {
		this.isModelCreated = isModelCreated;
	}
	...
	public String getIsGridValidated() {
		return isGridValidated;
	}

	public void setIsGridValidated(String isGridValidated) {
		this.isGridValidated = isGridValidated;
	}

	public String getIsModelValidated() {
		return isModelValidated;
	}

	public void setIsModelValidated(String isModelValidated) {
		this.isModelValidated = isModelValidated;
	}

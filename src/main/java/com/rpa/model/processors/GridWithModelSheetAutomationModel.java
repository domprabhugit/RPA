...
@Entity
@Table(name="Grid_Model_Automation")
public class GridWithModelSheetAutomationModel  implements  Serializable {
	...
	@Id
	@SequenceGenerator(name = "gridModel_automation_seq", sequenceName = "gridModel_automation_seq", allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="gridModel_automation_seq")
	private long id;

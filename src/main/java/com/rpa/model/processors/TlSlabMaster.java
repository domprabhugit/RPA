...
@Entity
@Table(name="TL_SLAB_MASTER")
public class TlSlabMaster implements  Serializable {

	@Id
	@SequenceGenerator(name = "tl_slab_master_seq", sequenceName = "tl_slab_master_seq", allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="tl_slab_master_seq")
	long id;

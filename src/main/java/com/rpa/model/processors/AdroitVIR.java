...
@Entity
@Table(name = "ADROIT_VIR")
public class AdroitVIR  implements Serializable   {
	...
	private String isImageDownloaded;
	...
	private String imagePdfPath;
	
	 @Temporal(TemporalType.TIMESTAMP)
	 private Date imageUploadedTime;
	 
	private byte[] imageRequest;
	...
	public String getIsImageDownloaded() {
		return isImageDownloaded;
	}

	public void setIsImageDownloaded(String isImageDownloaded) {
	...
	public String getImagePdfPath() {
		return imagePdfPath;
	}

	public void setImagePdfPath(String imagePdfPath) {
		this.imagePdfPath = imagePdfPath;
	}

	public Date getImageUploadedTime() {
		return imageUploadedTime;
	}

	public void setImageUploadedTime(Date imageUploadedTime) {
	...
	public void setImageRequest(byte[] imageRequest) {
	...
	public void setImageResponse(byte[] imageResponse) {
